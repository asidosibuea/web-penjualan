	...
	<div class="container">
		...
		<div class="row">
			 <form:form id="formHeader" class="form-horizontal"
			  method="post" action="${pageContext.request.contextPath}/header-penjualan/final-post" modelAttribute="headerPenjualan">
					  ...
					  <table class="table table-striped">
					    ...
					    <tbody>
						    ...
						    <tr>
						    	...
						    	<td>
						        	<a href="${pageContext.request.contextPath}/header-penjualan/delete-detail/${data.noNota}" class="btn btn-danger"> <span class="glyphicon glyphicon-remove"></span> Delete</a>
						        </td>
						    </tr>
						    </c:forEach>
					    </tbody>
...
function submitForm() {
	document.getElementById("formHeader").action = "/mvcpenjualan/header-penjualan/save";
